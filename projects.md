...
img: ./img/sandbox-build-1.mp4::Early stage starter kit docs with Square Market theme, ./img/sandbox-build-2.mp4::Adapt prototype to POS app experience, ./img/sandbox-build-3.mp4::Toggle hotspots on prototypes, ./img/sandbox-build-4.mp4::Workflow: Create a project and add templates, ./img/sandbox-build-5.mp4::Workflow: Navigate through workflow template in canvas, ./img/sandbox-build-6.mp4::Ungroup a workflow and edit states individually
...
img: ./diagrams/market-starter-architecture.mmd::Abstraction architecture, ./diagrams/market-starter-workflow.mmd::Workflow architecture for building pages, ./img/sandbox-iterate-3.mp4::Local sandbox docs, ./img/sandbox-iterate-4.mp4::Local sandbox build
...
role: Design lead
device: macbook-pro
device-image: ./img/multi-ein-design-2.mp4
...
img: ./img/multi-ein-research-1.mp4::Discovery: Literary and design reviews across Square product teams, ./img/multi-ein-research-2.png::Ideation: Co-design workshops with Square teams to ideate on key opportunity workflows,
...
img: ./img/multi-ein-design-1.mp4::Exploration of different account model architecture, ./img/multi-ein-design-2.mp4::Vision: Manage multiple businesses from a central place, ./img/multi-ein-design-3.mp4::Tax notices and business verification workflows, ./img/multi-ein-design-4.mp4::Workflow: Verify additional business entities, ./img/multi-ein-design-5.mp4::Workflow: Create location custom attribute, ./img/multi-ein-design-6.mp4::Workflow: Create location group
...
img: ./img/multi-ein-outcome-1.png::Square for Enterprises: Organization dashboard, ./img/multi-ein-outcome-2.png::Square for Enterprises: Reporting by location group, ./img/multi-ein-outcome-3.png::Square for Enterprises: Merchant onboarding for organizations
...
img: ./img/g2-context-1.mp4::Workflow: Customer advocate resolving hardware issue, ./img/g2-context-2.png::Sales associate launchpad
...
img: ./img/g2-framework-1.png::Account manager launchpad
...
img: ./img/g2-prototype-1.mp4::Workflow: Lead sourcing and vetting for sales
...
img: ./img/rdm-context-1.png::Hardware Hub: Space in each POS where sellers could manage locally connected devices
...
img: ./img/rdm-approach-1.mp4::Discovery: Design sprint synthesis + feature evaluation + prioritization ./img/rdm-approach-2.png::Framework: Status definitions + status by device type, ./img/rdm-approach-3.png::Framework: Logic for device metadata, ./img/rdm-approach-4.mp4::Exploration: Device details, ./img/rdm-approach-5.png::Exploration: Data visualization, ./img/rdm-approach-6.mp4::Device fleet overview dashboard, ./img/rdm-approach-7.mp4::Real-time device monitoring
...
img: ./img/rdm-evolution-1.mp4::Exploration: Diagnostic test flow and visual patterns, ./img/rdm-evolution-2.mp4::Workflow: Run device diagnostic test, ./img/rdm-evolution-3.mp4::Workflow: Bulk create device codes, ./img/rdm-evolution-4.png::Exploration: Device code details
...
timeline: 2020
device: macbook-pro
device-image: ./img/rpa-hover.png

### Context | Manual and slow controls
img: ./img/automation-portal-context-3.png::Manual automation assessments + file tracking + permissions management
...
img: ./img/automation-portal-design-2.mp4::Blueprint: Production files monitoring workflow, ./img/automation-portal-design-1.mp4::Concept: Robotic process automation landing page, ./img/automation-portal-context-2.mp4::Exploration: Key workflows across different roles
...
img: ./img/automation-portal-approach-3.mp4::Workflow: Assess automation opportunity, ./img/automation-portal-approach-1.mp4::Workflow: Register bot, ./img/automation-portal-approach-2.mp4::Workflow: Edit permissions, ./img/automation-portal-design-3.mov::Developer Portal: Workflow: Review requests, img: ./img/automation-portal-context-1.jpg::Detail: Bot promotion request
...
timeline: 2019 – 2020
device: macbook-pro
device-image: ./img/design-system-design-3.jpg

### Context | Decentralized development
img: ./img/design-system-approach-5.png::GSK experiences using different themes and code,
./img/design-system-approach-3.mov::Inventory audits for components across 5+ experiences
...
img:   ./img/design-system-approach-4.png +  ./img/design-system-approach-7.png::Exploration: Themes, 
./img/design-system-approach-6.png::Theming: Tokens and mapping leveraging Material, 
./img/design-system-context-1.jpg::Discovery: Developer workflow and opportunity mapping,
./img/design-system-approach-6.mov::Concept: Design system landing page,
./img/design-system-approach-2.mov::Sketch UI kit
...
img: ./img/design-system-design-1.mp4::Launch walkthrough, 
./img/design-system-design-2.jpg::Docs: CDN install, 
./img/design-system-design-3.jpg::Docs: Component detail page in Developer Portal catalog, 
./img/design-system-design-7.png::Comms for launches + workshops + events
